...
static inline cache_t *create_cache(const char *trace_path,
  ...
  static const eviction_algo_entry_t simple_algos[] = {
      ...
      {"lirs", LIRS_init},
      {"lru", LRU_init},
      {"lruforgive", LRUForgive_init},
      {"lru-forgive", LRUForgive_init},
      {"lruforgiveclean", LRUForgiveClean_init},
      {"lru-forgive-clean", LRUForgiveClean_init},
      {"lruforgiveembcache", LRUForgiveEmbCache_init},
      {"lru-forgive-embcache", LRUForgiveEmbCache_init},
      {"lrufreq", LRUFreq_init},
      {"lru-freq", LRUFreq_init},
      {"lrubottomk", LRUBottomK_init},
      {"lru-bottomk", LRUBottomK_init},
      {"lruembdiag", LRUEmbDiag_init},
      {"lru-emb-diag", LRUEmbDiag_init},
      ...
      {"sieve", Sieve_init},
      {"sieveemb", SieveEmb_init},
      {"sievebottomk", SieveBottomK_init},
      {"sieve-bottomk", SieveBottomK_init},
      {"sieveembforgive", SieveEmbForgive_init},
      {"sieve-emb-forgive", SieveEmbForgive_init},
      {"s3fifoemb", S3FIFOEmb_init},
      {"s3-fifoemb", S3FIFOEmb_init},
      {"s3fifoforgive", S3FIFOForgive_init},
      {"s3-fifoforgive", S3FIFOForgive_init},
      {"s3fifoforgiveclean", S3FIFOForgiveClean_init},
      {"s3-fifo-forgive-clean", S3FIFOForgiveClean_init},
      {"s3fifoforgive-onlyevict", S3FIFOForgiveOnlyEvict_init},
      {"s3-fifo-forgive-onlyevict", S3FIFOForgiveOnlyEvict_init},
      {"s3fifoforgive-embcache", S3FIFOForgiveEmbCache_init},
      {"s3-fifo-forgive-embcache", S3FIFOForgiveEmbCache_init},
      {"size", Size_init},
      {"slru", SLRU_init},
      {"slruv0", SLRUv0_init},
      {"twoq", TwoQ_init},
